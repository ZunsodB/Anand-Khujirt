    ...
    return (
        <section id="intro" className="py-20 sm:py-28 bg-cream">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                {/* Description */}
                <p className="text-lg sm:text-xl text-charcoal leading-relaxed max-w-2xl mx-auto">
                    Манай сувилал нь өдгөө 10 дах жилдээ үйл ажиллагаа явуулж буй.
                    Байгалиас ундрах халуун рашаан, шавар эмчилгээгээр таны биеийн үе мөчний
                    өвчинг анагааж, эрүүл мэндийг сэргээх үйлчилгээг бид үзүүлнэ.
